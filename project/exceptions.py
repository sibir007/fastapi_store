...
class HTTP_401_UNAUTHORIZED_EXCEPTION(HTTPException):
...
class HTTP_500_INTERNAL_SERVER_ERROR_EXCEPTION(HTTPException):
...
def raise_exaption(code: int, detail: str) -> None:
    match code:
        case status.HTTP_401_UNAUTHORIZED:
            raise HTTP_401_UNAUTHORIZED_EXCEPTION(detail)
        case status.HTTP_500_INTERNAL_SERVER_ERROR:
            raise HTTP_500_INTERNAL_SERVER_ERROR_EXCEPTION(detail)
        case _:
